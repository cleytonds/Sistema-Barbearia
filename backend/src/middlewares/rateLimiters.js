...
export const loginLimiter = rateLimit({ ...base, windowMs: 15 * 60_000, limit: 5, keyGenerator: accountKey, skipSuccessfulRequests: true });
export const registerLimiter = rateLimit({ ...base, windowMs: 60 * 60_000, limit: 5 });
export const recoveryLimiter = rateLimit({ ...base, windowMs: 15 * 60_000, limit: 3, keyGenerator: accountKey });
export const resetLimiter = rateLimit({ ...base, windowMs: 15 * 60_000, limit: 5 });
export const passwordLimiter = rateLimit({ ...base, windowMs: 60 * 60_000, limit: 5, keyGenerator: userKey });
export const authenticatedLimiter = rateLimit({ ...base, windowMs: 15 * 60_000, limit: 300, keyGenerator: userKey });
